...
module AisToNmea
  module Encoders
    module Mixins
      # Mapping helper methods for encoders, providing access to YAML-defined field mappings and normalization.
      module Mapping
        def parts_mapping
          @parts_mapping ||= begin
        ...
        def all_parts_mappings
          @all_parts_mappings ||= YAML.safe_load_file(self.class::MAPPING_CONFIG_PATH, aliases: true)
